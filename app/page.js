...
const baseKpis = [
  ...
  },
  {
    ...
    shifts: {
      ...
      Night: { jan: 0.90, feb: 1.15, mar: 1.16, apr: 1.16, value: 1.16 },
    },
  },
  {
    title: "Miss Packing",
  ...
  },
  {
    ...
    direction: "lower",
    shifts: {
      Morning: { jan: 0.01, feb: 0.00, mar: 0.00, apr: 0.01, value: 0.01 },
      Afternoon: { jan: 0.01, feb: 0.01, mar: 0.01, apr: 0.02, value: 0.02 },
      Night: { jan: 0.01, feb: 0.00, mar: 0.00, apr: 0.01, value: 0.01 },
    },
  },
  {
...

  {
    ...
    shifts: {
      ...
      Afternoon: { jan: 0.22, feb: 0.20, mar: 0.24, apr: 0.22, value: 0.22 },
      Night: { jan: 0.22, feb: 0.24, mar: 0.40, apr: 0.32, value: 0.32 },
    },
  },
  {
    ...
    direction: "lower",
    shifts: {
      Morning: { jan: 0.09, feb: 0.09, mar: 0.10, apr: 0.07, value: 0.07 },
      Afternoon: { jan: 0.10, feb: 0.09, mar: 0.09, apr: 0.07, value: 0.07 },
      Night: { jan: 0.09, feb: 0.10, mar: 0.09, apr: 0.07, value: 0.07 },
    },
  },
  {
  ...
  },
  {
    ...
    shifts: {
      ...
      Afternoon: { jan: 0.110, feb: 0.047, mar: 0.030, apr: 0.013, value: 0.013 },
      Night: { jan: 0.077, feb: 0.050, mar: 0.030, apr: 0.009, value: 0.009 },
    },
  },

  {
    ...
    shifts: {
      ...
      Afternoon: { jan: 0.20, feb: 0.24, mar: 0.16, apr: 0.10, value: 0.10 },
  ...
  },
  {
    ...
    direction: "higher",
    shifts: {
      Morning: { jan: 44.25, feb: 39.80, mar: 42.18, apr: 47.01, value: 47.01 },
  ...
  },
  {
    ...
    shifts: {
      ...
      Afternoon: { jan: 0.18, feb: 0.29, mar: 0.23, apr: 0.10, value: 0.10 },
    ...
    <main style={{ background: "#020617", minHeight: "100vh", color: "white", padding: "34px", fontFamily: "Arial" }}>
      <header style={{ marginBottom: "28px" }}>
        ...
        <p style={{ color: "#94a3b8", fontSize: "18px" }}>
          Monthly performance view · January to April · Target vs Actual · {selectedShift} Shift
        </p>
      </header>
      ...
      <section style={{ ...panel, marginBottom: "30px" }}>
        <h2 style={{ fontSize: "28px", marginBottom: "8px" }}>
          Attention Indicators · {selectedShift} Shift Deep Dive
        </h2>

        <p style={{ color: "#94a3b8", marginBottom: "24px" }}>
          Indicadores fora da meta no turno selecionado.
        </p>
